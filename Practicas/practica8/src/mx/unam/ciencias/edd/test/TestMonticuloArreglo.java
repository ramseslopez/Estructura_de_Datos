...
public class TestMonticuloArreglo {
    ...
    private int total;
    /* El montículo mínimo. */
    private MonticuloArreglo<Indexable<String>> monticulo;
    /* Arreglo auxiliar. */
    private Indexable<String>[] arreglo;
    ...
    public TestMonticuloArreglo() {
        ...
        @SuppressWarnings("unchecked")
            Indexable<String>[] a =
            (Indexable<String>[])new Indexable[total];
        arreglo = a;
        ...
        monticulo = new MonticuloArreglo<Indexable<String>>(lista);
    ...
    @Test public void testConstructor() {
        ...
        MonticuloArreglo<Indexable<String>> m2;
        m2 = new MonticuloArreglo<Indexable<String>>(lista, total);
        for (int i = 0; i < total; i++)
    ...
    @Test public void testElimina() {
        Lista<Indexable<String>> ordenada =
            new Lista<Indexable<String>>();
        ...
        while (!monticulo.esVacia()) {
            ...
            Indexable<String> b = ordenada.eliminaPrimero();
